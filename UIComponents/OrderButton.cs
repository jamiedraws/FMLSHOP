...
namespace FMLSHOP.UIComponents
{
    public class OrderButton
    {
        ...
        public OrderButton(string text = "Order Now", string classList = "button")
        {
            Text = text;
            ClassList = classList;
        }
        ...
        {
            string attributeList = string.Format(@"href=""#order"" class=""{0}""{1}", classList ?? ClassList, ApplyAttributes());

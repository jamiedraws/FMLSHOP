<%@ Page Language="C#" MasterPageFile="~/VersionViews/1.0000/Views/Layouts/ArticleLayout.master" Inherits="System.Web.Mvc.ViewPage<ClientSiteViewData>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="/css/Site1/blog-article.css" rel="preload" as="style" />
    <link href="/css/Site1/blog-article.css" rel="stylesheet" />
</asp:Content>
...
<main aria-labelledby="main-title" class="view article section">
    ...
    <div class="view__in section__in">
        ...
        %>
        <picture class="article__picture contain contain--excerpt-thumb">

...
<asp:Content ID="ProductHeroBanner" ContentPlaceHolderID="ProductHeroBanner" runat="server">
    <section aria-labelledby="hero-F7V-title" class="hero hero--product-detail-banner">
        <div class="view__in hero__in section__in">
            <div class="hero__group">
                <picture class="hero__media">
                    <source srcset="/images/Site1/hero-banners/F7V/product.webp" type="image/webp">
                    <img src="/images/Site1/hero-banners/F7V/product.jpg" alt="Flip 7 Vanilla" width="588" height="795">
                </picture>
                <div class="hero__text">
                    <span id="hero-F7V-title" class="hero__title">
...
<asp:Content ID="ProductImageCarouselThumbnail" ContentPlaceHolderID="ProductImageCarouselThumbnail" runat="server">
    <button type="button" aria-label="Product video 1" class="contain contain--square" data-modal-dialog-id="pdp-video-1" data-modal-dialog-actor="open" data-modal-dialog-iframe="https://player.vimeo.com/video/827002534?title=0&byline=0&portrait=0" data-modal-dialog-title="Video" data-modal-dialog-template-modifier="video" data-src-img="/images/Site1/products/default.svg" data-attr='{ "width":"120", "height":"163", "loading":"lazy", "alt": ""}'>
    </button>
</asp:Content>  
...
<asp:Content ID="FeaturesSection" ContentPlaceHolderID="FeaturesSection" runat="server">
    <h3 class="product__headline">
        <span>1 SHAKE A DAY FOR WHOLE BODY WELLNESS.</span>
        <small>15 servings</small>
        <small>The most comprehensive, convenient Super Food Meal Replacement to help you age better.</small>
    </h3>

    <h4>VITAL VANILLA SHAKE</h4>
...
<asp:Content ID="ProductReviews" ContentPlaceHolderID="ProductReviews" runat="server">
    ...
    {
        { "ImageUrl", "/images/Site1/reviews/F7V/photo.jpg" },
        { "ImageAlt", "" },

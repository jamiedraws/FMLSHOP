...
namespace FMLSHOP.Utils
{
    public class ResourceWriter
    {
        ...
        /// <summary>
        /// Writes an HTML link element to defer-load a CSS resource
        /// </summary>
        /// <param name="relativePath"></param>
        /// <returns></returns>
        public string WriteLinkDefer(string relativePath)
        {
            return string.Format(@"<link rel=""stylesheet"" href=""{0}"" media=""print"" onload=""this.media = 'all'; this.onload = null;"">
                <noscript>
                   <link rel=""stylesheet"" href=""{0}"">
                </noscript>", AddQueryStringParameterToRelativePathOrDefault(relativePath));
        }

        /// <summary>
        /// Writes an HTML script element to defer-load a JS resource
        /// </summary>
        /// <param name="relativePath"></param>
        /// <returns></returns>
        public string WriteScriptDefer(string relativePath)
        {

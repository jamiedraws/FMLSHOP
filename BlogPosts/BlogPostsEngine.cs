...
namespace FMLSHOP.BlogPosts
{
    public class BlogPostsEngine
    {
        ...
        /// </summary>
        public readonly string DefaultThumbnail = "/images/blog/default.svg";
        ...
        {
            return string.Format("{0}/{1}?cver={2}", GetCategoryRoute(blogPost).Replace(string.Format("?cver={0}", DtmContext.VersionId), string.Empty), blogPost.UrlSlug, DtmContext.VersionId).ToLower();
        }
        ...
        {
            return string.Format("/{0}?cver={1}", tagSlug, DtmContext.VersionId).ToLower();
        }
        ...
        {
            return (tagSlug ?? string.Empty).Replace(string.Format("?cver={0}", DtmContext.VersionId), string.Empty).Replace("-", " ");
        }
        ...
        {
            return string.Format("{0}/{1}?cver={2}", GetParentRoute(tagSlug).Replace(string.Format("?cver={0}", DtmContext.VersionId), string.Empty), categorySlug, DtmContext.VersionId);
        }
